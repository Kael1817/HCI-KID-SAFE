    ...
    <div className="relative flex justify-between py-10 px-70 min-h-screen bg-quaternary">
          ...
          ></div>
            ...
            <div className='content flex flex-col items-center justify-center w-full h-full z-10'>
              ...
              <p className='text-white text-lg mb-3'>Additional Information</p>
              <input type="text" placeholder='Email' className='bg-white rounded-lg w-full h-10 p-5 text-lg mb-3' />
              <input type="text" placeholder='Advisory Class' className='bg-white rounded-lg w-full h-10 p-5 text-lg mb-3' />
              <input type="text" placeholder='Adviser Name' className='bg-white rounded-lg w-full h-10 p-5 text-lg mb-3' />
              <div className='flex justify-between w-full mb-15 gap-4'>
                ...
                <input type="text" placeholder='Subject' className='bg-white rounded-lg h-10 p-5 text-lg w-[469px]' />
              </div>
