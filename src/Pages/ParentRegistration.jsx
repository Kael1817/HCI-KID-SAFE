      ...
      ></div>
        ...
        <div className='content flex flex-col items-center justify-between w-full h-full z-10 '>
          ...
          <div className='flex justify-between w-full mb-5'>
            ...
            <input type="date" placeholder='Birthdate' className='bg-white rounded-lg h-12 p-5 text-lg w-[545px] cursor-pointer' />
          </div>
          </div>
          
          <p className='text-white text-xl mb-3'>Student Information</p>
          <div className='flex flex-col items-center w-full'>
            <input type="text" placeholder='Full Name' className='bg-white rounded-lg w-full h-12 p-5 text-lg mb-3' />
          <input type="text" placeholder='Contact Number' className='bg-white rounded-lg w-full h-12 p-5 text-lg mb-3' />
          ...
          <div className='flex justify-between w-full mb-15'>
            <input type="text" placeholder='Grade Level' className='bg-white rounded-lg h-12 p-5 text-lg w-[545px]' />
            <input type="text" placeholder='Section' className='bg-white rounded-lg h-12 p-5 text-lg w-[545px]' />
          </div>
