      ...
      <div className="relative z-10 flex justify-between w-full">
        ...
        <div className="login-panel w-[450px] h-[581px] p-9 bg-[rgba(144,159,170,0.8)] rounded-4xl">
          <div className="login-content flex flex-col items-center gap-4 h-full">
            <h1 className="text-5xl text-primary font-headings mb-20">RESET PASSWORD</h1>
            <input type="text" placeholder="New Password" id="new-password" className="bg-white rounded-[10px] w-full h-11 p-2.5"/>
            <input type="text" placeholder="Confirm Password" id="confirm-password" className="bg-white rounded-[10px] w-full h-11 p-2.5 mb-20"/>
            <button className="bg-primary text-white font-bold w-full h-11 rounded-xl cursor-pointer text-xl">Save</button>
